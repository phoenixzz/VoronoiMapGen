...
#define __SGP_OPENGLVERTEXBUFFEROBJECT_HEADER__

class COpenGLVertexBufferObject
{
public:
	COpenGLVertexBufferObject(COpenGLRenderDevice* pRenderDevice) 
...
#endif		// __SGP_OPENGLVERTEXBUFFEROBJECT_HEADER__