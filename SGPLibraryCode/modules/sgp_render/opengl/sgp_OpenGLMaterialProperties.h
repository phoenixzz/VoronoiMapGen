...
#define __SGP_OPENGLMATERIALPROPERTIES_HEADER__
...
// PolygonOffset (Render Mode FILL depth bias)
...
// PolygonFillLineOffsetProperty (Render Mode LINE depth bias)
class PolygonFillLineOffsetProperty : public ISGPMaterialProperty
{
public :
	inline PolygonFillLineOffsetProperty( GLfloat factor, GLfloat units ) : factor_(factor), units_(units) {}
	virtual ISGPMaterialProperty * Clone() const { return new PolygonFillLineOffsetProperty(factor_, units_); }
	REGISTER_BEGIN;
	REGISTER_END;
...
#endif		// __SGP_OPENGLMATERIALPROPERTIES_HEADER__