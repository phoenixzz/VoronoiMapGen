...
char Shader_anim_alphatest_VS_String[] = 
	"#version 330											\n"\
	"														\n"\
...
char Shader_anim_alphatest_PS_String[] = 
	"#version 330																	\n"\
	"																				\n"\
	...
	"void main()																	\n"\
	"{																				\n"\
	"	vec4 DiffuseColor = texture2D(gSampler0, vTexCoordPass);					\n"\
