...
char Shader_lightmap_alphatest_VS_String[] = 
	"#version 330																\n"\
	"																			\n"\
	"layout (location = 0) in vec3 inPosition;									\n"\
	"layout (location = 1) in vec2 inCoord0;									\n"\
	"layout (location = 2) in vec2 inCoord1;									\n"\
	"																			\n"\
...
char Shader_lightmap_alphatest_PS_String[] = 
	"#version 330																\n"\
	"																			\n"\
	...
	"void main()																\n"\
	"{																			\n"\
	"	outputColor = texture2D(gSampler0, vTexCoordPass0);						\n"\
	"	// Alpha-test															\n"\
