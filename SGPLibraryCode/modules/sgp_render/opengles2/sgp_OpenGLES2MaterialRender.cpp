int COpenGLES2MaterialRenderer::m_OpaqueRenderBatchPoolUsed = 0;
int COpenGLES2MaterialRenderer::m_TransparentRenderBatchPoolUsed = 0;
int COpenGLES2MaterialRenderer::m_AlphaTestRenderBatchPoolUsed = 0;
int COpenGLES2MaterialRenderer::m_ParticlePSRenderBatchPoolUsed = 0;
int COpenGLES2MaterialRenderer::m_ParticleLineRenderBatchPoolUsed = 0;
int COpenGLES2MaterialRenderer::m_ParticleQuadRenderBatchPoolUsed = 0;
int COpenGLES2MaterialRenderer::m_LineRenderBatchPoolUsed = 0;
int COpenGLES2MaterialRenderer::m_SkinAnimRenderBatchPoolUsed = 0;


COpenGLES2MaterialRenderer::COpenGLES2MaterialRenderer(COpenGLES2RenderDevice *pRenderDevice)
...
COpenGLES2MaterialRenderer::~COpenGLES2MaterialRenderer()
{
}

int	COpenGLES2MaterialRenderer::ComputeMaterialPass()
{
...
void COpenGLES2MaterialRenderer::OnePassPreRenderMaterial(int pass)
{
	// pre render
...
void COpenGLES2MaterialRenderer::OnePassPostRenderMaterial(int pass)
{
	// post render
	for( int j = m_FirstMaterial; j >= 0; --j )
	{
...
void COpenGLES2MaterialRenderer::Draw( ISGPRenderBatch::BatchType BTtype )
{
...
void COpenGLES2MaterialRenderer::FastDraw( ISGPRenderBatch::BatchType BTtype )
{
...
void COpenGLES2MaterialRenderer::SlowDraw( ISGPRenderBatch::BatchType BTtype )
{
	// compute the first active material
...
void COpenGLES2MaterialRenderer::RenderBatchDrawCall( ISGPRenderBatch::BatchType BTtype )
{
	switch( BTtype )
	{
	...
	case ISGPRenderBatch::eBatchTransparent:
		...
		break;
	case ISGPRenderBatch::eBatchAlphaTest:
		{
	...
	case ISGPRenderBatch::eBatchSkinAnim:
		...
		break;
	case ISGPRenderBatch::eBatchSkinAnimAlphaTest:
		{
			ISGPRenderBatch::m_SkinAnimShaderLightmapTexSetted = false;
...
void COpenGLES2MaterialRenderer::QueueRenderBatch()
{
	COpenGLES2MaterialRenderer::Sorter CompareRenderBatch;
...
void COpenGLES2MaterialRenderer::BeforeDrawRenderBatch()
{
	m_OpaqueRenderBatchPoolUsed = 0;
	m_TransparentRenderBatchPoolUsed = 0;
	m_AlphaTestRenderBatchPoolUsed = 0;
...
void COpenGLES2MaterialRenderer::AfterDrawRenderBatch()
{
	m_OpaqueRenderBatchPoolUsed = 0;
	m_TransparentRenderBatchPoolUsed = 0;
	m_AlphaTestRenderBatchPoolUsed = 0;
...
void COpenGLES2MaterialRenderer::DoDrawRenderBatch_Opaque()
{
...
void COpenGLES2MaterialRenderer::DoDrawRenderBatch_Transparent()
{
	ISGPMaterialSystem::MaterialList &Mat_List = GetOpenGLRenderDevice()->GetMaterialSystem()->GetMaterialList();
...
void COpenGLES2MaterialRenderer::DoDrawRenderBatch_AlphaTest()
{
	ISGPMaterialSystem::MaterialList &Mat_List = GetOpenGLRenderDevice()->GetMaterialSystem()->GetMaterialList();
	// Normal alpha-test RenderBatch
	if( (m_alphaTestBatch.size() > 0) || (m_alphaTestLightMapBatch.size() > 0) )
	{
		const ISGPMaterialSystem::SGPMaterialInfo &TransparentMaterial_info = Mat_List.getReference(ISGPMaterialSystem::eMaterial_alphatest);
		PushMaterial( TransparentMaterial_info.m_material, MM_Add );
		Draw( ISGPRenderBatch::eBatchAlphaTest );
		PopMaterial();
	}
}

void COpenGLES2MaterialRenderer::DoDrawRenderBatch_DebugLine()
{
	ISGPMaterialSystem::MaterialList &Mat_List = GetOpenGLRenderDevice()->GetMaterialSystem()->GetMaterialList();
...
void COpenGLES2MaterialRenderer::DoDrawRenderBatch_NoDepthline()
{
	ISGPMaterialSystem::MaterialList &Mat_List = GetOpenGLRenderDevice()->GetMaterialSystem()->GetMaterialList();
	ISGPMaterialSystem::MaterialList &Mod_List = GetOpenGLRenderDevice()->GetMaterialSystem()->GetModifierList();
...
void COpenGLES2MaterialRenderer::DoDrawRenderBatch_Particle()
{
	ISGPMaterialSystem::MaterialList &Mat_List = GetOpenGLRenderDevice()->GetMaterialSystem()->GetMaterialList();
...
void COpenGLES2MaterialRenderer::DoDrawRenderBatch_SkinAnim()
{
	ISGPMaterialSystem::MaterialList &Mat_List = GetOpenGLRenderDevice()->GetMaterialSystem()->GetMaterialList();
...
void COpenGLES2MaterialRenderer::DoDrawRenderBatch_SkinAnimAlpha()
{
	ISGPMaterialSystem::MaterialList &Mat_List = GetOpenGLRenderDevice()->GetMaterialSystem()->GetMaterialList();
...
void COpenGLES2MaterialRenderer::DoDrawRenderBatch_SkinAnimAlphaTest()
{
	ISGPMaterialSystem::MaterialList &Mat_List = GetOpenGLRenderDevice()->GetMaterialSystem()->GetMaterialList();

	// Skin Anim AlphaTest RenderBatch
	if( m_skinanimAlphaTestBatch.size() > 0 )
	{
		const ISGPMaterialSystem::SGPMaterialInfo &SkinAnimAlphaMaterial_info = Mat_List.getReference(ISGPMaterialSystem::eMaterial_alphatest);
		PushMaterial( SkinAnimAlphaMaterial_info.m_material, MM_Add );
		Draw( ISGPRenderBatch::eBatchSkinAnimAlphaTest );
		PopMaterial();
	}
}

void COpenGLES2MaterialRenderer::PushOpaqueRenderBatch(const COpaqueRenderBatch& batch)
{
...
void COpenGLES2MaterialRenderer::PushTransparentRenderBatch(const CTransparentRenderBatch& batch)
{
...
void COpenGLES2MaterialRenderer::PushAlphaTestRenderBatch(const CAlphaTestRenderBatch& batch)
{
	CAlphaTestRenderBatch *pNewBatch = (CAlphaTestRenderBatch*)GetOneFreeRenderBatchFromPool(ISGPRenderBatch::eBatchAlphaTest);
...
void COpenGLES2MaterialRenderer::PushLineRenderBatch(const CLineRenderBatch& batch)
{
...
void COpenGLES2MaterialRenderer::PushParticlePSRenderBatch(const CParticlePSRenderBatch& batch)
{
...
void COpenGLES2MaterialRenderer::PushParticleLineRenderBatch(const CParticleLineRenderBatch& batch)
{
...
void COpenGLES2MaterialRenderer::PushParticleQuadRenderBatch(const CParticleQuadRenderBatch& batch)
{
...
void COpenGLES2MaterialRenderer::PushSkinAnimRenderBatch(const CSkinAnimRenderBatch& batch)
{
	...
	if( pNewBatch )
	{
		...
		pNewBatch->m_pSB = batch.m_pSB;
		pNewBatch->m_pVC = batch.m_pVC;
		pNewBatch->m_BoneMatrixBuffer = batch.m_BoneMatrixBuffer;
		pNewBatch->m_BoneNum = batch.m_BoneNum;
		pNewBatch->m_BatchConfig = batch.m_BatchConfig;
...
ISGPRenderBatch* COpenGLES2MaterialRenderer::GetOneFreeRenderBatchFromPool(ISGPRenderBatch::BatchType BTtype)
{
	...
	case ISGPRenderBatch::eBatchAlphaTest:
		if( m_AlphaTestRenderBatchPoolUsed + 1 >= m_AlphaTestRenderBatchPool.size() )
		{
			m_AlphaTestRenderBatchPool.add( new CAlphaTestRenderBatch(m_pRenderDevice) );
			pBatch = m_AlphaTestRenderBatchPool.getLast();
		}
		else
		{
			pBatch = m_AlphaTestRenderBatchPool.getUnchecked(m_AlphaTestRenderBatchPoolUsed);
		}
		m_AlphaTestRenderBatchPoolUsed++;
		break;
...
void COpenGLES2MaterialRenderer::ReAllocRenderBatchPool()
{
