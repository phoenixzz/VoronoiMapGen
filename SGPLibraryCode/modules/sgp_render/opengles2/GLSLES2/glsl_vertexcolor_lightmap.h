const char *Shader_vertexcolor_lightmap_Attribute_String[] = { "inPosition", "inColor", "inCoord0", "inCoord1" };

char Shader_vertexcolor_lightmap_VS_String[] = 
	"																						\n"\
...
char Shader_vertexcolor_lightmap_PS_String[] = 
	"																					\n"\
	"varying lowp vec4 vVertexColor;													\n"\
	"varying mediump vec2 vTexCoordPass0;												\n"\
	"varying mediump vec2 vTexCoordPass1;												\n"\
	...
	"uniform mediump vec4 SunColor;			// ambient color and Intensity				\n"\

	"void main()																		\n"\
	"{																					\n"\
	"	gl_FragColor = texture2D(gSampler0, vTexCoordPass0) * vVertexColor;				\n"\
