...
public:
	...
	typedef void* (GL_APIENTRY * PFNGLMAPBUFFERRANGEEXT) (GLenum target, GLintptr offset, GLsizeiptr length, GLbitfield access);
	typedef void (GL_APIENTRY * PFNGLFLUSHMAPPEDBUFFERRANGEEXT) (GLenum target, GLintptr offset, GLsizeiptr length);
