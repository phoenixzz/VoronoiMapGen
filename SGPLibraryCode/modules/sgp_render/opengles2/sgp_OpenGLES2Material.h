...
private :
    ...
    SGP_DECLARE_NON_COPYABLE (OpenGLES2Material)
...
private:
	//EMaterialResult SetupTexturing( const OpenGLES2Material::Script & script, OpenGLES2Material::Script::Section & scriptPass, Pass & pass );
	EMaterialResult SetupAlphaBlending( const OpenGLES2Material::Script & script, OpenGLES2Material::Script::Section & scriptPass, Pass & pass );
	EMaterialResult SetupStencil( const OpenGLES2Material::Script & script, OpenGLES2Material::Script::Section & scriptPass, Pass & pass );
	EMaterialResult SetupVarious( const OpenGLES2Material::Script & script, OpenGLES2Material::Script::Section & scriptPass, Pass & pass );
...
#endif		// __SGP_OPENGLES2MATERIAL_HEADER__