...
COpenGLES2SkydomeRenderer::COpenGLES2SkydomeRenderer(COpenGLES2RenderDevice *pRenderDevice)
	: m_pRenderDevice(pRenderDevice), m_SkydomeStaticBuffer(NULL), m_SunColorAndIntensity(1.0f, 1.0f, 1.0f, 0.1f)
{
}

COpenGLES2SkydomeRenderer::~COpenGLES2SkydomeRenderer()
{
}

void COpenGLES2SkydomeRenderer::updateSkydomeMaterialSkin(const CSGPSkyDome* pSkyDome)
{
...
void COpenGLES2SkydomeRenderer::update(float fDeltaTimeInSecond, CSGPSkyDome* pSkyDome, const Vector4D& campos)
{
	if( !pSkyDome )
		return;
	...
	if( pSkyDome->m_bUpdateModel )
	{
		...
		{
			m_SkydomeStaticBuffer = (COpenGLES2StaticBuffer*)
...
void COpenGLES2SkydomeRenderer::render(CSGPSkyDome* pSkyDome)
{
...
void COpenGLES2SkydomeRenderer::DoDrawSkydomeRenderBatch()
{
...
void COpenGLES2SkydomeRenderer::DoDrawReflectionSkydomeRenderBatch()
{
	if( m_SkydomeStaticBuffer == NULL )
		return;
