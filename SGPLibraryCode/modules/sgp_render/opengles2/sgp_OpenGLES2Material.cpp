OpenGLES2Material::Script::Section::Section()
{
}



OpenGLES2Material::Script::Section::Section( char *MaterialStr )
{
	BuildInfo buildInfo( MaterialStr, true );
	LoadFromMaterialStr( buildInfo );
}

void OpenGLES2Material::Script::Section::CharToUpper( char* str )
{
	while( *str != 0 )
	{
		if( *str >= 'a' && *str <= 'z' )
...
void OpenGLES2Material::Script::Section::CharTrimLeftRight(char* str )
{
	int strLeftIdx = 0;
...
int OpenGLES2Material::Script::Section::Char_Find_first_of( const char* SrcStr, const char SubStr, int index )
{
	int StrIdx = 0;
...
int OpenGLES2Material::Script::Section::Char_Find_first_not_of( const char* SrcStr, const char* SubStr, int index )
{
	int StrIdx = 0;
...
int OpenGLES2Material::Script::Section::Char_Find_last_not_of( const char* SrcStr, const char* SubStr, int str_len )
{
	str_len--;
	while(str_len >= 0)
	{
...
void OpenGLES2Material::Script::Section::LoadFromMaterialStr( BuildInfo & buildInfo )
{
	char *line = NULL;
	char *id = NULL;
...
void OpenGLES2Material::Script::Section::ReadSection( BuildInfo & buildInfo, char* id )
{
	char *line = NULL;
...
// ReadValue()
void OpenGLES2Material::Script::Section::ReadValue( BuildInfo & , char* line, int index )
{
	char *id = line;
...
// IsAlphaNumeric()
bool OpenGLES2Material::Script::Section::IsAlphaNumeric( char c )
{
	return ( c >= 'a' && c <= 'z' ) ||
		   ( c >= 'A' && c <= 'Z' ) ||
		   ( c >= '0' && c <= '9' ) ||
...
// GetLine()
bool OpenGLES2Material::Script::Section::GetLine( BuildInfo & buildInfo, char** line )
{
	int StrOffset = 0;
...
int OpenGLES2Material::Script::Section::ContainSection( const char* id )
{
	int Found = 0;
...
OpenGLES2Material::Script::Section* OpenGLES2Material::Script::Section::GetSection( const char* name, int ID )
{
	int FoundIdx = 0;
...
// ContainString()
bool OpenGLES2Material::Script::Section::ContainString( const char* id )
{
...
// GetString()
const char* OpenGLES2Material::Script::Section::GetString( const char* id, const char* def )
{
	for(int i=0; i<LineID_.size(); i++)
	{
		if( STRNICMP(id, LineID_[i], strlen(id) ) == 0 )
...
// GetInt()
int OpenGLES2Material::Script::Section::GetInt( const char* id, int def )
{
	for(int i=0; i<LineID_.size(); i++)
	{
		if( STRNICMP(id, LineID_[i], strlen(id) ) == 0 )
...
// GetFloat()
float OpenGLES2Material::Script::Section::GetFloat( const char* id, float def )
{
	for(int i=0; i<LineID_.size(); i++)
		if( STRNICMP(id, LineID_[i], strlen(id) ) == 0 )
...
// ContainBool()
bool OpenGLES2Material::Script::Section::ContainBool( const char* id )
{
	for(int i=0; i<LineID_.size(); i++)
		if( STRNICMP(id, LineID_[i], strlen(id) ) == 0 )
			return true;
...
// GetBool()
bool OpenGLES2Material::Script::Section::GetBool( const char* id, bool def )
{
	for(int i=0; i<LineID_.size(); i++)
	{
		if( STRNICMP(id, LineID_[i], strlen(id) ) == 0 )
...
// GetVec4()
Vector4D OpenGLES2Material::Script::Section::GetVec4( const char* id, const Vector4D & def )
{
...
// ctor
OpenGLES2Material::Script::Script( char* MaterialStr ) :
	global_( NULL )
{
...
// dtor
OpenGLES2Material::Script::~Script()
{
	delete global_;
	global_ = NULL;
}
...
// Clone()
OpenGLES2Material::Pass * OpenGLES2Material::Pass::Clone()
{
...
void OpenGLES2Material::Pass::AddProperty( ISGPMaterialProperty * property )
{
	begin_.add( property );
...
//void OpenGLES2Material::Pass::UpdateTexture(uint32 texID, uint8 unit)
//{
//	for( int i = 0; i < begin_.size(); ++i )
...
// PreRender()
void OpenGLES2Material::Pass::PreRender()
{
	for( int i = 0; i < begin_.size(); ++i )
		begin_[i]->Begin();
}
...
// PostRender()
void OpenGLES2Material::Pass::PostRender()
{
...
// ctor
OpenGLES2Material::OpenGLES2Material() :
	AbstractMaterial()
{
...
// ctor
OpenGLES2Material::OpenGLES2Material( char* MaterialStr ) :
	AbstractMaterial()
{
...
void OpenGLES2Material::Clone( AbstractMaterial *pSrcMaterial )
{
	if( !pSrcMaterial )
		return;
...
// LoadFromMaterialStr()
void OpenGLES2Material::LoadFromMaterialStr( char* str )
{
	Clear();
...
// Update()
void OpenGLES2Material::Update( float elapsedTime )
{
	for( int i=0; i<passes_.size(); ++i )
	{
...
/*
GLint OpenGLES2Material::TextureAddressingModes( const char* mode )
{
...
GLint OpenGLES2Material::TextureFilteringModes( const char* mode )
{
...
*/
/*
OpenGLES2Material::EMaterialResult OpenGLES2Material::SetupTexturing( const Script & , Script::Section & scriptPass, Pass & pass )
{
...
SGP_BLEND_FACTOR OpenGLES2Material::AlphaBlendFunc( const char* func )
{
...
SGP_BLEND_OPERATION OpenGLES2Material::AlphaBlendOp( const char* op )
{
...
OpenGLES2Material::EMaterialResult OpenGLES2Material::SetupAlphaBlending( const Script & , Script::Section & scriptPass, Pass & pass )
{
...
SGP_COMPARISON_FUNC OpenGLES2Material::StencilFunc( const char* func )
{
...
GLenum OpenGLES2Material::StencilOp( const char* op )
{
...
OpenGLES2Material::EMaterialResult OpenGLES2Material::SetupStencil( const Script & , Script::Section & scriptPass, Pass & pass )
{
...
OpenGLES2Material::EMaterialResult OpenGLES2Material::SetupVarious( const Script & , Script::Section & scriptPass, Pass & pass )
{
