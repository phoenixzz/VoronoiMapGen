...
#define __SGP_OPENGLES2CAMERA_HEADER__

/**
Here is a useful class to create a opengl es 2.0 camera. 
...
public:
	COpenGLES2Camera(ISGPRenderDevice *renderdevice) : m_pRenderDevice(renderdevice),
...
#endif		// __SGP_OPENGLES2CAMERA_HEADER__