...
#define __SGP_DIRECTORYITERATOR_HEADER__
...
*/
class SGP_API  DirectoryIterator
{
public:
    //==============================================================================
...
private:
    ...
    private:
        ...
        SGP_DECLARE_NON_COPYABLE (NativeIterator)
    };
    ...
    SGP_DECLARE_NON_COPYABLE (DirectoryIterator)
};

#endif   // __SGP_DIRECTORYITERATOR_HEADER__
