...
#define __SGP_FILEOUTPUTSTREAM_HEADER__
...
*/
class SGP_API  FileOutputStream  : public OutputStream
{
public:
    //==============================================================================
...
private:
    ...
    SGP_DECLARE_NON_COPYABLE (FileOutputStream)
};

#endif   // __SGP_FILEOUTPUTSTREAM_HEADER__
