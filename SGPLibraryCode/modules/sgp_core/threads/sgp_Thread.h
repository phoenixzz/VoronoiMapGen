...
#define __SGP_THREAD_HEADER__

#include "sgp_WaitableEvent.h"
#include "sgp_CriticalSection.h"
...
public:
    ...
    */
    ...
    static void SGP_CALLTYPE sleep (int milliseconds);

    /** Yields the calling thread's current time-slot. */
    static void SGP_CALLTYPE yield();
    ...
    */
    ...
    /** Finds the thread object that is currently running.
        ...
        Note that the main UI thread (or other non-SGP threads) don't have a Thread
...
private:
    ...
    friend void SGP_API sgp_threadEntryPoint (void*);
    ...
    SGP_DECLARE_NON_COPYABLE (Thread)
};

#endif   // __SGP_THREAD_HEADER__
