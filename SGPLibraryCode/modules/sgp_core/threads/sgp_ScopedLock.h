...
#define __SGP_SCOPEDLOCK_HEADER__
...
private:
    ...
    SGP_DECLARE_NON_COPYABLE (GenericScopedLock)
};
...
private:
    ...
    SGP_DECLARE_NON_COPYABLE (GenericScopedUnlock)
};
...
private:
    ...
    SGP_DECLARE_NON_COPYABLE (GenericScopedTryLock)
};


#endif   // __SGP_SCOPEDLOCK_HEADER__
