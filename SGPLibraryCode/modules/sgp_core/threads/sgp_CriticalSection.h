...
#define __SGP_CRITICALSECTION_HEADER__
...
private:
    //==============================================================================
   #if SGP_WINDOWS
    // To avoid including windows.h in the public SGP headers, we'll just allocate a
    ...
    SGP_DECLARE_NON_COPYABLE (CriticalSection)
};
...
*/
class SGP_API  DummyCriticalSection
{
public:
...
private:
    SGP_DECLARE_NON_COPYABLE (DummyCriticalSection)
};
...
#endif   // __SGP_CRITICALSECTION_HEADER__
