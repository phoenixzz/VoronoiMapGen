...
namespace
{
    File sgp_readlink (const String& file, const File& defaultFile)
    {
...
//{
//    return sgp_readlink (getFullPathName().toUTF8(), *this);
//}
...
File File::getSpecialLocation (const SpecialLocationType type)
{
    switch (type)
    {
        ...
        case hostApplicationPath:
            return sgp_readlink ("/proc/self/exe", sgp_getExecutableFile());
