                                ...
                                jstring appFile_, jstring appDataDir_)
{
    ...
    appFile = sgpString (env, appFile_);
    appDataDir = sgpString (env, appDataDir_);
}
...
namespace AndroidStatsHelpers
{
    ...
    {
        return sgpString (LocalRef<jstring> ((jstring) getEnv()->CallStaticObjectMethod (SystemClass,
    ...
    {
        return sgpString (LocalRef<jstring> ((jstring) getEnv()->CallStaticObjectMethod (sgpAppActivity,
                                                                                          sgpAppActivity.getLocaleValue,
                                                                                          isRegion)));
    }
}
