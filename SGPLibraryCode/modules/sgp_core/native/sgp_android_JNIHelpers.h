...
#ifndef __SGP_ANDROID_JNIHELPERS_HEADER__
#define __SGP_ANDROID_JNIHELPERS_HEADER__

#if ! (defined (SGP_ANDROID_ACTIVITY_CLASSNAME) && defined (SGP_ANDROID_ACTIVITY_CLASSPATH))
 #error "The SGP_ANDROID_ACTIVITY_CLASSNAME and SGP_ANDROID_ACTIVITY_CLASSPATH macros must be set!"
#endif
...
namespace
{
    String sgpString (JNIEnv* env, jstring s)
    {
    ...
    String sgpString (jstring s)
    {
        return sgpString (getEnv(), s);
    }
    ...
    LocalRef<jstring> javaStringFromChar (const sgp_wchar c)
    {
        char utf8[8] = { 0 };
...
private:
    ...
    SGP_DECLARE_NON_COPYABLE (JNIClassBase)
};
...
//==============================================================================
#define SGP_JNI_CALLBACK(className, methodName, returnType, params) \
  extern "C" __attribute__ ((visibility("default"))) returnType SGP_JOIN_MACRO (SGP_JOIN_MACRO (Java_, className), _ ## methodName) params
...
#define JNI_CLASS_MEMBERS(METHOD, STATICMETHOD, FIELD, STATICFIELD) \
 METHOD (createNewView,          "createNewView",        "(Z)L" SGP_ANDROID_ACTIVITY_CLASSPATH "$ComponentPeerView;") \
 METHOD (deleteView,             "deleteView",           "(L" SGP_ANDROID_ACTIVITY_CLASSPATH "$ComponentPeerView;)V") \
 ...
 STATICMETHOD (createHTTPStream, "createHTTPStream",     "(Ljava/lang/String;Z[BLjava/lang/String;ILjava/lang/StringBuffer;)L" SGP_ANDROID_ACTIVITY_CLASSPATH "$HTTPStream;") \
...
DECLARE_JNI_CLASS (sgpAppActivity, SGP_ANDROID_ACTIVITY_CLASSPATH);
...
#endif   // __SGP_ANDROID_JNIHELPERS_HEADER__
