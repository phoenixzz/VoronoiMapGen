#ifndef __SGP_BASICNATIVEHEADERS_HEADER__
#define __SGP_BASICNATIVEHEADERS_HEADER__
...
//==============================================================================
 ...
 #if SGP_MSVC
  #ifndef _CPPRTTI
   #error "You're compiling without RTTI enabled! This is needed for a lot of SGP classes, please update your compiler settings!"
  #endif

  #ifndef _CPPUNWIND
   #error "You're compiling without exceptions enabled! This is needed for a lot of SGP classes, please update your compiler settings!"
  #endif
 ...
 */
 #define SGP_LOAD_WINAPI_FUNCTION(dll, functionName, localFunctionName, returnType, params) \
...
#endif   // __SGP_BASICNATIVEHEADERS_HEADER__
