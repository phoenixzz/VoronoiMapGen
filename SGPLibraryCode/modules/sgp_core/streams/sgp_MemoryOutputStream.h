...
#define __SGP_MEMORYOUTPUTSTREAM_HEADER__

#include "sgp_OutputStream.h"
...
*/
class SGP_API  MemoryOutputStream  : public OutputStream
{
public:
    //==============================================================================
...
private:
    ...
    SGP_DECLARE_NON_COPYABLE (MemoryOutputStream)
};
...
#endif   // __SGP_MEMORYOUTPUTSTREAM_HEADER__
