...
#define __SGP_CHARPOINTER_UTF8_HEADER__
...
public:
    ...
    sgp_wchar operator[] (int characterIndex) const noexcept
    {
    ...
    */
    ...
    void write (const sgp_wchar charToWrite) noexcept
    {
        const uint32 c = (uint32) charToWrite;
...
#endif   // __SGP_CHARPOINTER_UTF8_HEADER__
