...
#define __SGP_CHARPOINTER_UTF16_HEADER__
...
public:
    ...
    sgp_wchar operator*() const noexcept
    {
    ...
    sgp_wchar getAndAdvance() noexcept
    {
        uint32 n = (uint32) (uint16) *data++;
    ...
    sgp_wchar operator[] (const int characterIndex) const noexcept
    {
    ...
    void write (sgp_wchar charToWrite) noexcept
    {
    ...
    */
    static size_t getBytesRequiredFor (const sgp_wchar charToWrite) noexcept
    {
    ...
    */
    ...
    sgp_wchar toUpperCase() const noexcept { return CharacterFunctions::toUpperCase (operator*()); }
    /** Returns a lower-case version of the first character of this string. */
    sgp_wchar toLowerCase() const noexcept { return CharacterFunctions::toLowerCase (operator*()); }
...
#endif   // __SGP_CHARPOINTER_UTF16_HEADER__
