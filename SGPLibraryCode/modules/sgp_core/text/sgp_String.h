...
#define __SGP_STRING_HEADER__

#include "sgp_CharacterFunctions.h"

#ifndef SGP_STRING_UTF_TYPE
 #define SGP_STRING_UTF_TYPE 8
#endif
...
#include "sgp_CharPointer_UTF8.h"
#include "sgp_CharPointer_UTF16.h"
#include "sgp_CharPointer_UTF32.h"
#include "sgp_CharPointer_ASCII.h"
...
public:
    ...
    */
    ...
    static String charToString (sgp_wchar character);
    ...
    */
    ...
    /** This is the character encoding type used internally to store the string.
        ...
        By setting the value of SGP_STRING_UTF_TYPE to 8, 16, or 32, you can change the
    ...
    */
   #if (SGP_STRING_UTF_TYPE == 32)
    typedef CharPointer_UTF32 CharPointerType;
   #elif (SGP_STRING_UTF_TYPE == 16)
    typedef CharPointer_UTF16 CharPointerType;
   #elif (SGP_STRING_UTF_TYPE == 8)
    typedef CharPointer_UTF8  CharPointerType;
   #else
    #error "You must set the value of SGP_STRING_UTF_TYPE to be either 8, 16, or 32!"
   #endif
    ...
    /** Appends a character at the end of this string. */
    String& operator+= (sgp_wchar characterToAppend);
   #endif
    ...
    */
    ...
    /** Tests whether the string begins with a particular character.
        ...
        Uses a case-sensitive comparison.
    */
    bool startsWithChar (sgp_wchar character) const noexcept;
    ...
    */
    ...
    /** Tests whether the string ends with a particular character.
        ...
        Uses a case-sensitive comparison.
    */
    bool endsWithChar (sgp_wchar character) const noexcept;
    ...
    */
    ...
    /** Tests whether the string contains a particular character.
        Uses a case-sensitive comparison.
    */
    bool containsChar (sgp_wchar character) const noexcept;
    ...
    */
    int indexOfChar (sgp_wchar characterToLookFor) const noexcept;
    ...
    /** Searches for a character inside this string.
        ...
        @returns            the index of the first occurrence of the character in this
                            string, or -1 if it's not found.
    */
    int indexOfChar (int startIndex, sgp_wchar characterToLookFor) const noexcept;
    ...
    */
    int lastIndexOfChar (sgp_wchar character) const noexcept;
    ...
    */
    ...
    /** Returns the character at this index in the string.
        ...
        @see getCharPointer
    */
    sgp_wchar operator[] (int index) const noexcept;

    /** Returns the final character of the string.
        If the string is empty this will return 0.
    */
    sgp_wchar getLastCharacter() const noexcept;
    ...
    */
    ...
    String replaceCharacter (sgp_wchar characterToReplace,
                             sgp_wchar characterToInsertInstead) const;
    ...
    */
    String quoted (sgp_wchar quoteCharacter = '"') const;
    ...
    */
    String paddedLeft (sgp_wchar padCharacter, int minimumLength) const;

    /** Returns a copy of this string with the specified character repeatedly added to its
        end until the total length is at least the minimum length specified.
    */
    String paddedRight (sgp_wchar padCharacter, int minimumLength) const;
...
private:
    ...
    SGP_DEPRECATED (String (const String& stringToCopy, size_t charsToAllocate));
...
SGP_API String SGP_CALLTYPE operator+ (const char* string1,     const String& string2);
/** Concatenates two strings. */
SGP_API String SGP_CALLTYPE operator+ (const wchar_t* string1,  const String& string2);
/** Concatenates two strings. */
SGP_API String SGP_CALLTYPE operator+ (char string1,            const String& string2);
/** Concatenates two strings. */
SGP_API String SGP_CALLTYPE operator+ (wchar_t string1,         const String& string2);
#if ! SGP_NATIVE_WCHAR_IS_UTF32
/** Concatenates two strings. */
SGP_API String SGP_CALLTYPE operator+ (sgp_wchar string1,      const String& string2);
#endif

/** Concatenates two strings. */
SGP_API String SGP_CALLTYPE operator+ (String string1, const String& string2);
/** Concatenates two strings. */
SGP_API String SGP_CALLTYPE operator+ (String string1, const char* string2);
/** Concatenates two strings. */
SGP_API String SGP_CALLTYPE operator+ (String string1, const wchar_t* string2);
/** Concatenates two strings. */
SGP_API String SGP_CALLTYPE operator+ (String string1, char characterToAppend);
/** Concatenates two strings. */
SGP_API String SGP_CALLTYPE operator+ (String string1, wchar_t characterToAppend);
#if ! SGP_NATIVE_WCHAR_IS_UTF32
/** Concatenates two strings. */
SGP_API String SGP_CALLTYPE operator+ (String string1, sgp_wchar characterToAppend);
#endif
...
SGP_API String& SGP_CALLTYPE operator<< (String& string1, short number);
/** Appends a decimal number at the end of a string. */
SGP_API String& SGP_CALLTYPE operator<< (String& string1, int number);
/** Appends a decimal number at the end of a string. */
SGP_API String& SGP_CALLTYPE operator<< (String& string1, long number);
/** Appends a decimal number at the end of a string. */
SGP_API String& SGP_CALLTYPE operator<< (String& string1, int64 number);
/** Appends a decimal number at the end of a string. */
SGP_API String& SGP_CALLTYPE operator<< (String& string1, float number);
/** Appends a decimal number at the end of a string. */
SGP_API String& SGP_CALLTYPE operator<< (String& string1, double number);

//==============================================================================
/** Case-sensitive comparison of two strings. */
SGP_API bool SGP_CALLTYPE operator== (const String& string1, const String& string2) noexcept;
/** Case-sensitive comparison of two strings. */
SGP_API bool SGP_CALLTYPE operator== (const String& string1, const char* string2) noexcept;
/** Case-sensitive comparison of two strings. */
SGP_API bool SGP_CALLTYPE operator== (const String& string1, const wchar_t* string2) noexcept;
/** Case-sensitive comparison of two strings. */
SGP_API bool SGP_CALLTYPE operator== (const String& string1, const CharPointer_UTF8& string2) noexcept;
/** Case-sensitive comparison of two strings. */
SGP_API bool SGP_CALLTYPE operator== (const String& string1, const CharPointer_UTF16& string2) noexcept;
/** Case-sensitive comparison of two strings. */
SGP_API bool SGP_CALLTYPE operator== (const String& string1, const CharPointer_UTF32& string2) noexcept;
/** Case-sensitive comparison of two strings. */
SGP_API bool SGP_CALLTYPE operator!= (const String& string1, const String& string2) noexcept;
/** Case-sensitive comparison of two strings. */
SGP_API bool SGP_CALLTYPE operator!= (const String& string1, const char* string2) noexcept;
...
//==============================================================================
/** This operator allows you to write a SGP String directly to std output streams.
    This is handy for writing strings to std::cout, std::cerr, etc.
*/
template <class traits>
std::basic_ostream <char, traits>& SGP_CALLTYPE operator<< (std::basic_ostream <char, traits>& stream, const String& stringToWrite)
{
...
*/
template <class traits>
std::basic_ostream <wchar_t, traits>& SGP_CALLTYPE operator<< (std::basic_ostream <wchar_t, traits>& stream, const String& stringToWrite)
{
    return stream << stringToWrite.toWideCharPointer();
}

/** Writes a string to an OutputStream as UTF8. */
SGP_API OutputStream& SGP_CALLTYPE operator<< (OutputStream& stream, const String& stringToWrite);


#endif   // __SGP_STRING_HEADER__
