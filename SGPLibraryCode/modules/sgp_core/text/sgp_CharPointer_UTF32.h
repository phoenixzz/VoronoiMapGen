...
#define __SGP_CHARPOINTER_UTF32_HEADER__
...
public:
    ...
    inline sgp_wchar operator*() const noexcept        { return *data; }
    ...
    inline sgp_wchar getAndAdvance() noexcept  { return *data++; }
    ...
    {
       #if SGP_NATIVE_WCHAR_IS_UTF32 && ! SGP_ANDROID
        return wcslen (data);
       #else
        size_t n = 0;
        while (data[n] != 0)
    ...
    */
    ...
    sgp_wchar toUpperCase() const noexcept { return CharacterFunctions::toUpperCase (*data); }
    /** Returns a lower-case version of the first character of this string. */
    sgp_wchar toLowerCase() const noexcept { return CharacterFunctions::toLowerCase (*data); }
...
#endif   // __SGP_CHARPOINTER_UTF32_HEADER__
