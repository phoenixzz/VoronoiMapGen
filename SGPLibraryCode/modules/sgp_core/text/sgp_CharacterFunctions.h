...
#define __SGP_CHARACTERFUNCTIONS_HEADER__


//==============================================================================
#if SGP_WINDOWS
 #define SGP_NATIVE_WCHAR_IS_UTF8      0
 #define SGP_NATIVE_WCHAR_IS_UTF16     1
 #define SGP_NATIVE_WCHAR_IS_UTF32     0
#else
 /** This macro will be set to 1 if the compiler's native wchar_t is an 8-bit type. */
 #define SGP_NATIVE_WCHAR_IS_UTF8      0
 /** This macro will be set to 1 if the compiler's native wchar_t is a 16-bit type. */
 #define SGP_NATIVE_WCHAR_IS_UTF16     0
 /** This macro will be set to 1 if the compiler's native wchar_t is a 32-bit type. */
 #define SGP_NATIVE_WCHAR_IS_UTF32     1
#endif

#if SGP_NATIVE_WCHAR_IS_UTF32
 /** A platform-independent 32-bit unicode character type. */
 typedef wchar_t        sgp_wchar;
#else
 typedef uint32         sgp_wchar;
#endif
...
*/
class SGP_API  CharacterFunctions
{
public:
    //==============================================================================
    /** Converts a character to upper-case. */
    static sgp_wchar toUpperCase (sgp_wchar character) noexcept;
    /** Converts a character to lower-case. */
    static sgp_wchar toLowerCase (sgp_wchar character) noexcept;

    /** Checks whether a unicode character is upper-case. */
    static bool isUpperCase (sgp_wchar character) noexcept;
    /** Checks whether a unicode character is lower-case. */
    static bool isLowerCase (sgp_wchar character) noexcept;

    /** Checks whether a character is whitespace. */
    static bool isWhitespace (char character) noexcept;
    /** Checks whether a character is whitespace. */
    static bool isWhitespace (sgp_wchar character) noexcept;

    /** Checks whether a character is a digit. */
    static bool isDigit (char character) noexcept;
    /** Checks whether a character is a digit. */
    static bool isDigit (sgp_wchar character) noexcept;

    /** Checks whether a character is alphabetic. */
    static bool isLetter (char character) noexcept;
    /** Checks whether a character is alphabetic. */
    static bool isLetter (sgp_wchar character) noexcept;

    /** Checks whether a character is alphabetic or numeric. */
    static bool isLetterOrDigit (char character) noexcept;
    /** Checks whether a character is alphabetic or numeric. */
    static bool isLetterOrDigit (sgp_wchar character) noexcept;

    /** Returns 0 to 16 for '0' to 'F", or -1 for characters that aren't a legal hex digit. */
    static int getHexDigitValue (sgp_wchar digit) noexcept;
    ...
    */
    ...
    static IntType getIntValue (const CharPointerType& text) noexcept
    {
        ...
        for (;;)
        {
            const sgp_wchar c = s.getAndAdvance();
    ...
    */
    ...
    static int indexOfChar (Type text, const sgp_wchar charToFind) noexcept
    {
        int i = 0;
    ...
    */
    template <typename Type>
    static int indexOfCharIgnoreCase (Type text, sgp_wchar charToFind) noexcept
    {
    ...
    */
    ...
    {
        Type t (text);
        sgp_wchar currentQuoteChar = 0;

        while (! t.isEmpty())
        {
            const sgp_wchar c = t.getAndAdvance();
...
#endif   // __SGP_CHARACTERFUNCTIONS_HEADER__
