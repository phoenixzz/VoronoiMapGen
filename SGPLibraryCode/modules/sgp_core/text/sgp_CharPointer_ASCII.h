...
#define __SGP_CHARPOINTER_ASCII_HEADER__
...
public:
    ...
    inline sgp_wchar operator*() const noexcept        { return (sgp_wchar) (uint8) *data; }
    ...
    inline sgp_wchar getAndAdvance() noexcept  { return (sgp_wchar) (uint8) *data++; }
    ...
    inline sgp_wchar operator[] (const int characterIndex) const noexcept
    {
        return (sgp_wchar) (unsigned char) data [characterIndex];
    }
    ...
    inline void write (const sgp_wchar charToWrite) noexcept
    {
        *data++ = (char) charToWrite;
    }

    inline void replaceChar (const sgp_wchar newChar) noexcept
    {
        *data = (char) newChar;
    }
    ...
    */
    static inline size_t getBytesRequiredFor (const sgp_wchar) noexcept
    {
        return 1;
    }
    ...
    */
    ...
    int indexOf (const sgp_wchar charToFind) const noexcept
    {
        int i = 0;
    ...
    /** Returns the character index of a unicode character, or -1 if it isn't found. */
    int indexOf (const sgp_wchar charToFind, const bool ignoreCase) const noexcept
    {
    ...
    bool isUpperCase() const                { return CharacterFunctions::isUpperCase ((sgp_wchar) (uint8) *data) != 0; }
    /** Returns true if the first character of this string is lower-case. */
    bool isLowerCase() const                { return CharacterFunctions::isLowerCase ((sgp_wchar) (uint8) *data) != 0; }

    /** Returns an upper-case version of the first character of this string. */
    sgp_wchar toUpperCase() const noexcept { return CharacterFunctions::toUpperCase ((sgp_wchar) (uint8) *data); }
    /** Returns a lower-case version of the first character of this string. */
    sgp_wchar toLowerCase() const noexcept { return CharacterFunctions::toLowerCase ((sgp_wchar) (uint8) *data); }
    ...
    static bool canRepresent (sgp_wchar character) noexcept
    {
...
#endif   // __SGP_CHARPOINTER_ASCII_HEADER__
