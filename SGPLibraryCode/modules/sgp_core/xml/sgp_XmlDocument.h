...
#define __SGP_XMLDOCUMENT_HEADER__
...
private:
    ...
    sgp_wchar readNextChar() noexcept;
    ...
    SGP_DECLARE_NON_COPYABLE (XmlDocument)
};



#endif		// __SGP_XMLDOCUMENT_HEADER__