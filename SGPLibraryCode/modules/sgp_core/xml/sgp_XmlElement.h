...
#define __SGP_XMLELEMENT_HEADER__
...
\
    for (sgp::XmlElement* childElementVariableName = (parentXmlElement).getFirstChildElement(); \
...
\
    for (sgp::XmlElement* childElementVariableName = (parentXmlElement).getChildByName (requiredTagName); \
         childElementVariableName != nullptr; \
...
#endif		// __SGP_XMLELEMENT_HEADER__