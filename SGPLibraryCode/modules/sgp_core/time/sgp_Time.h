...
#define __SGP_TIME_HEADER__

#include "sgp_RelativeTime.h"
...
public:
    ...
    */
    static Time SGP_CALLTYPE getCurrentTime() noexcept;
...
SGP_API Time operator+ (const Time& time, const RelativeTime& delta);
/** Adds a RelativeTime to a Time. */
SGP_API Time operator+ (const RelativeTime& delta, const Time& time);

/** Subtracts a RelativeTime from a Time. */
SGP_API Time operator- (const Time& time, const RelativeTime& delta);
/** Returns the relative time difference between two times. */
SGP_API const RelativeTime operator- (const Time& time1, const Time& time2);

/** Compares two Time objects. */
SGP_API bool operator== (const Time& time1, const Time& time2);
/** Compares two Time objects. */
SGP_API bool operator!= (const Time& time1, const Time& time2);
/** Compares two Time objects. */
SGP_API bool operator<  (const Time& time1, const Time& time2);
