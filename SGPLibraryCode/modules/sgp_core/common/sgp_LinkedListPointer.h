...
#define __SGP_LINKEDLISTPOINTER_HEADER__
...
public:
    ...
    */
    ...
    private:
        ...
        SGP_DECLARE_NON_COPYABLE (Appender)
    };
...
private:
    ...
    SGP_DECLARE_NON_COPYABLE (LinkedListPointer)
};


#endif   // __SGP_LINKEDLISTPOINTER_HEADER__
