...
#define __SGP_OWNEDARRAY_HEADER__

#include "sgp_ArrayAllocationBase.h"
#include "sgp_ElementComparator.h"
...
private:
    ...
    SGP_DECLARE_NON_COPYABLE (OwnedArray)
};


#endif   // __SGP_OWNEDARRAY_HEADER__
