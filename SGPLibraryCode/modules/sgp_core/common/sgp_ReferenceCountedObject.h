...
#define __SGP_REFERENCECOUNTEDOBJECT_HEADER__

#include "sgp_Atomic.h"
...
*/
class SGP_API  ReferenceCountedObject
{
public:
    //==============================================================================
...
*/
class SGP_API  SingleThreadedReferenceCountedObject
{
public:
    //==============================================================================
    /** Increments the object's reference count.
...
#endif   // __SGP_REFERENCECOUNTEDOBJECT_HEADER__
