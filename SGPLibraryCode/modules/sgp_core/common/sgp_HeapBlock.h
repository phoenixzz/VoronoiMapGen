...
#define __SGP_HEAPBLOCK_HEADER__
...
private:
    ...
    SGP_DECLARE_NON_COPYABLE (HeapBlock)
    SGP_PREVENT_HEAP_ALLOCATION // Creating a 'new HeapBlock' would be missing the point!

};


#endif   // __SGP_HEAPBLOCK_HEADER__
