...
public:
	...
	void BeganTwoTouch(float vec2Location[2][2], PVRShellInit* init);
	void MovedTwoTouch(float vec2Location[2][2], PVRShellInit* init);
	void EndedTwoTouch(float vec2Location[2][2], PVRShellInit* init);
