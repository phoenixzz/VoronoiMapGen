...
protected:
	...
	float m_vec2TwoPointerLocation[4];
	float m_vec2TwoPointerLocationStart[4];
	float m_vec2TwoPointerLocationEnd[4];	

	// Touch handling
	bool m_bTouching;
	bool m_bTwoPointTouching;
...
public:
	...
	*************************************************************************/
	void TwoTouchBegan(const float vec2Location[4]);
	
	/*!***********************************************************************
	@brief     Used by the OS-specific code to tell the Shell that a two point touch has began at a location.
	@param[in] vec2Location The two position of the pointer/touch pressed on the screen.
	*************************************************************************/
	void TwoTouchMoved(const float vec2Location[4]);
	...
	*************************************************************************/
	void TwoTouchEnded(const float vec2Location[4]);
